module Helli
  ...
  module Open3
    class << self
      ...
      # Open3.capture3t captures the standard output and the standard error of a command within a given timeout.
      #
      # Process will return nil if timeout is reached.
      #   Helli::Open3.capture3t[2].exitstatus #=> nil
      #
      # Possible options:
      ...
      # Open3.capture2et captures the standard output and the standard error of a command within a given timeout.
      #
      # Process will return nil if timeout is reached.
      #   Helli::Open3.capture3t[2].exitstatus #=> nil
      #
      ...
      # Open3.capture2t captures the standard output of a command within a given timeout.
      #
      # Process will return nil if timeout is reached.
      #   Helli::Open3.capture3t[2].exitstatus #=> nil
      #
