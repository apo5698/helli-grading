    ...
    <html>
      ...
      <body>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td class="text-align:right">Designed for use with <a href='http://checkstyle.sourceforge.net/'>CheckStyle
    ...
    <table class="log" border="0" cellpadding="5" cellspacing="2" width="100%">
      ...
      <xsl:for-each select="error">
        <tr>
          ...
          <td>
            <a>
              <xsl:attribute name="href"><xsl:value-of select="$html.dir"/>/<xsl:value-of
                      select="substring-after(../@name, $src.dir)"/>.html#
